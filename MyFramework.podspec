...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/lixiangshadow/MyFramework"
  ...
  spec.author             = { "李祥" => "136702480@qq.com" }
  # Or just: spec.author    = "李祥"
  # spec.authors            = { "李祥" => "136702480@qq.com" }
  # spec.social_media_url   = "https://twitter.com/李祥"
  ...
  spec.source       = { :git => "https://github.com/lixiangshadow/MyFramework.git", :tag => spec.version }
  ...
  # spec.source_files  = "MyFramework.framework/**/*.{h}"
  ...
  spec.dependency "BMKLocationKit"
